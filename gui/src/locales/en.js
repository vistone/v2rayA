export default {
  ...
  pool: {
    ...
    pollInterval: "Poll interval",
  	  ...
  	  strategyRandom: "Random parallel: spread connections across all nodes, add bandwidth",
  	  strategyRoundRobin: "Round-robin parallel: connections alternate across all nodes, add bandwidth",
  	  strategyLeastPing: "Lowest latency: always use one node (no bandwidth aggregation)",
