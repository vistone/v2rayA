export default {
  ...
  pool: {
    ...
    pollInterval: "Poll interval",
	  ...
	  strategyLeastPing: "Lowest latency: pin one node, long-lived connections reused (no bandwidth aggregation under concurrency)",
	  strategyRandom: "Random parallel (default): spread connections across all nodes, aggregate bandwidth",
	  strategyRoundRobin: "Round-robin parallel: alternate connections across all nodes, aggregate bandwidth",
