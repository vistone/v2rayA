export default {
  ...
  pool: {
    ...
    pollInterval: "Poll interval",
	  ...
	  strategyLeastPing: "Lowest latency (default): pin one node, long-lived connections reused, best for most cases",
	  strategyRandom: "Random parallel: spread connections across all nodes (multi-thread / multi-device only)",
	  strategyRoundRobin: "Round-robin parallel: alternate connections across all nodes (multi-thread / multi-device only)",
